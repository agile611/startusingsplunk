...
Los índices son la base del almacenamiento y la recuperación de eventos en
Splunk. Para un administrador, comprenderlos bien es esencial porque los datos
no solo “entran”, también deben quedar en la ubicación correcta para poder
consultarse, analizarse y gestionar con eficacia.

Cuando se trabaja con Splunk, casi todas las dudas de “no veo resultados” se
resuelven revisando cuatro cosas: la fuente, el índice, el rango temporal y los
permisos. El índice es una de las piezas más importantes de esa validación.
