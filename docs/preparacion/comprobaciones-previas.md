...
Las comprobaciones previas no terminan al confirmar que Splunk está instalado.
La plataforma debe estar operativa y los datos deben ser verificables.
...
Con esta validación completada, el asistente puede comenzar las prácticas con una
base reproducible y distinguir correctamente entre problemas del sistema,
problemas de Splunk y problemas del dataset.